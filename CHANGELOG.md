...
## [beta](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/tree/beta) (2026/05/22)
...
- Add build comparison tab [\#1830](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1830) ([vaisest](https://github.com/vaisest))
...
### Fixed Crashes
- Fix crash when importing some builds to party tab [\#1872](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1872) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix crash on import from private league [\#1874](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1874) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix crash on loading build due to some minion skills [\#1880](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1880) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix crash wehn opening some old builds [\#1925](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1925) ([unrealdreamz](https://github.com/unrealdreamz))
### User Interface
...
- Surface OAuth token exchange errors [\#1922](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1922) ([unrealdreamz](https://github.com/unrealdreamz))
### Fixed Calculations
...
- Fix projectile spell block EHP [\#1875](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1875) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix caluclation of some stats when using Ingenuity [\#1882](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1882) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix generic Minion damage mods applying to Inspiring Ally [\#1884](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1884) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix Undying Hate attribute passive bonuses not working [\#1902](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1902) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix Palm skills not using Quarterstaff Damage and Crit [\#1903](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1903) ([unrealdreamz](https://github.com/unrealdreamz))
### Fixed Behaviours
...
- Fix pasted items not selecting correct runes [\#1877](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1877) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix item-granted skills counting toward socket group limit [\#1883](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1883) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix Uhtred supports counting Meta gems as supports [\#1896](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1896) ([unrealdreamz](https://github.com/unrealdreamz))
- Gate Barrage incorrectly granting damage to some skills [\#1897](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1897) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix Stomping Ground and Ferocious Roar not working when using a Talisman [\#1901](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1901) ([unrealdreamz](https://github.com/unrealdreamz))
...
- Fix Item granted skills not showing up as Implicits when pasting [\#1873](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1873) ([unrealdreamz](https://github.com/unrealdreamz))
- Fix Show All Configurations hiding some options [\#1892](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/1892) ([unrealdreamz](https://github.com/unrealdreamz))
### Other changes
